...
def get_recommended_list(user_name):
    data_manager = Manager.get_data_manager()
    recommended_list = data_manager.get_recommended_list(user_name)
    send_message('200', recommended_list, 'OK')
    pass


def main():
    user_name = parse_argv()
    get_recommended_list(user_name)
    pass
